              ...
              >
                ...
                <GridItem colSpan={10}>
                  <div class="flex flex-col items-center justify-center px-6 py-2 bg-gray-900">
                    ...
                    <p class="flex items-end mt-2 text-base text-center text-gray-400 gap-x-2">Find available dates for your stay! 
                    ...
                    <div class="grid w-full max-w-xl grid-cols-7 gap-6 mx-auto">
                      <div class="relative w-full h-12 cursor-pointer hover:scale-110 box bg-gradient-primary after:absolute after:inset-0 after:z-10 after:h-full after:w-full after:transition-opacity after:duration-500 hover:bg-white">
                        <div class="absolute inset-[3px] z-20 flex items-center justify-center bg-pink-900 text-white">1</div>
                      </div>
                      ...
                      <div class="relative w-full h-12 cursor-pointer hover:scale-110 box bg-gradient after:absolute after:inset-0 after:z-10 after:h-full after:w-full after:transition-opacity after:duration-500 hover:bg-white">
                        <div class="absolute inset-[3px] z-20 flex items-center justify-center bg-pink-900 text-white">2</div>
                      </div>

                      <div class="relative w-full h-12 cursor-pointer hover:scale-110 box bg-gradient after:absolute after:inset-0 after:z-10 after:h-full after:w-full after:transition-opacity after:duration-500 hover:bg-white">
                        <div class="absolute inset-[3px] z-20 flex items-center justify-center bg-pink-900 opacity-25 text-white">3</div>
                      </div>

                      <div class="relative w-full h-12 cursor-pointer hover:scale-110 box bg-gradient after:absolute after:inset-0 after:z-10 after:h-full after:w-full after:transition-opacity after:duration-500 hover:bg-white">
                        <div class="absolute inset-[3px] z-20 flex items-center justify-center bg-pink-900 text-white">4</div>
                      </div>

                      <div class="relative w-full h-12 cursor-pointer hover:scale-110 box bg-gradient after:absolute after:inset-0 after:z-10 after:h-full after:w-full after:transition-opacity after:duration-500 hover:bg-white">
                        <div class="absolute inset-[3px] z-20 flex items-center justify-center bg-pink-900 text-white">5</div>
                      </div>

                      <div class="relative w-full h-12 cursor-pointer hover:scale-110 box bg-gradient after:absolute after:inset-0 after:z-10 after:h-full after:w-full after:transition-opacity after:duration-500 hover:bg-white">
                        <div class="absolute inset-[3px] z-20 flex items-center justify-center bg-pink-900 opacity-25 text-white">6</div>
                      </div>

                      <div class="relative w-full h-12 cursor-pointer hover:scale-110 box bg-gradient after:absolute after:inset-0 after:z-10 after:h-full after:w-full after:transition-opacity after:duration-500 hover:bg-white">
                        <div class="absolute inset-[3px] z-20 flex items-center justify-center bg-pink-900 text-white">7</div>
                      </div>

                      <div class="relative w-full h-12 cursor-pointer hover:scale-110 box bg-gradient after:absolute after:inset-0 after:z-10 after:h-full after:w-full after:transition-opacity after:duration-500 hover:bg-white">
                        <div class="absolute inset-[3px] z-20 flex items-center justify-center bg-pink-900 text-white">8</div>
                      </div>

                      <div class="relative w-full h-12 cursor-pointer hover:scale-110 box bg-gradient after:absolute after:inset-0 after:z-10 after:h-full after:w-full after:transition-opacity after:duration-500 hover:bg-white">
                        <div class="absolute inset-[3px] z-20 flex items-center justify-center bg-pink-900 opacity-25 text-white">9</div>
                      </div>

                      <div class="relative w-full h-12 cursor-pointer hover:scale-110 box bg-gradient after:absolute after:inset-0 after:z-10 after:h-full after:w-full after:transition-opacity after:duration-500 hover:bg-white">
                        <div class="absolute inset-[3px] z-20 flex items-center justify-center bg-pink-900 text-white">10</div>
                      </div>

                      <div class="relative w-full h-12 cursor-pointer hover:scale-110 box bg-gradient after:absolute after:inset-0 after:z-10 after:h-full after:w-full after:transition-opacity after:duration-500 hover:bg-white">
                        <div class="absolute inset-[3px] z-20 flex items-center justify-center bg-pink-900 opacity-25 text-white">11</div>
                      </div>

                      <div class="relative w-full h-12 cursor-pointer hover:scale-110 box bg-gradient after:absolute after:inset-0 after:z-10 after:h-full after:w-full after:transition-opacity after:duration-500 hover:bg-white">
                        <div class="absolute inset-[3px] z-20 flex items-center justify-center bg-pink-900 opacity-25 text-white">12</div>
                      </div>

                      <div class="relative w-full h-12 cursor-pointer hover:scale-110 box bg-gradient after:absolute after:inset-0 after:z-10 after:h-full after:w-full after:transition-opacity after:duration-500 hover:bg-white">
                        <div class="absolute inset-[3px] z-20 flex items-center justify-center bg-pink-900 opacity-25 text-white">13</div>
                      </div>

                      <div class="relative w-full h-12 cursor-pointer hover:scale-110 box bg-gradient after:absolute after:inset-0 after:z-10 after:h-full after:w-full after:transition-opacity after:duration-500 hover:bg-white">
                        <div class="absolute inset-[3px] z-20 flex items-center justify-center bg-pink-900 opacity-25 text-white">14</div>
                      </div>

                      <div class="relative w-full h-12 cursor-pointer hover:scale-110 box bg-gradient after:absolute after:inset-0 after:z-10 after:h-full after:w-full after:transition-opacity after:duration-500 hover:bg-white">
                        <div class="absolute inset-[3px] z-20 flex items-center justify-center bg-pink-900 text-white">15</div>
                      </div>

                      <div class="relative w-full h-12 cursor-pointer hover:scale-110 box bg-gradient after:absolute after:inset-0 after:z-10 after:h-full after:w-full after:transition-opacity after:duration-500 hover:bg-white">
                        <div class="absolute inset-[3px] z-20 flex items-center justify-center bg-pink-900 opacity-25 text-white">16</div>
                      </div>

                      <div class="relative w-full h-12 cursor-pointer hover:scale-110 box bg-gradient after:absolute after:inset-0 after:z-10 after:h-full after:w-full after:transition-opacity after:duration-500 hover:bg-white">
                        <div class="absolute inset-[3px] z-20 flex items-center justify-center bg-pink-900 opacity-25 text-white">17</div>
                      </div>

                      <div class="relative w-full h-12 cursor-pointer hover:scale-110 box bg-gradient after:absolute after:inset-0 after:z-10 after:h-full after:w-full after:transition-opacity after:duration-500 hover:bg-white">
                        <div class="absolute inset-[3px] z-20 flex items-center justify-center bg-pink-900 text-white">18</div>
                      </div>

                      <div class="relative w-full h-12 cursor-pointer hover:scale-110 box bg-gradient after:absolute after:inset-0 after:z-10 after:h-full after:w-full after:transition-opacity after:duration-500 hover:bg-white">
                        <div class="absolute inset-[3px] z-20 flex items-center justify-center bg-pink-900 text-white">19</div>
                      </div>

                      <div class="relative w-full h-12 cursor-pointer hover:scale-110 box bg-gradient after:absolute after:inset-0 after:z-10 after:h-full after:w-full after:transition-opacity after:duration-500 hover:bg-white">
                        <div class="absolute inset-[3px] z-20 flex items-center justify-center bg-pink-900 opacity-25 text-white">20</div>
                      </div>

                      <div class="relative w-full h-12 cursor-pointer hover:scale-110 box bg-gradient after:absolute after:inset-0 after:z-10 after:h-full after:w-full after:transition-opacity after:duration-500 hover:bg-white">
                        <div class="absolute inset-[3px] z-20 flex items-center justify-center bg-pink-900 opacity-25 text-white">21</div>
                      </div>

                      <div class="relative w-full h-12 cursor-pointer hover:scale-110 box bg-gradient after:absolute after:inset-0 after:z-10 after:h-full after:w-full after:transition-opacity after:duration-500 hover:bg-white">
                        <div class="absolute inset-[3px] z-20 flex items-center justify-center bg-pink-900 text-white">22</div>
                      </div>

                      <div class="relative w-full h-12 cursor-pointer hover:scale-110 box bg-gradient after:absolute after:inset-0 after:z-10 after:h-full after:w-full after:transition-opacity after:duration-500 hover:bg-white">
                        <div class="absolute inset-[3px] z-20 flex items-center justify-center bg-pink-900 opacity-25 text-white">23</div>
                      </div>

                      <div class="relative w-full h-12 cursor-pointer hover:scale-110 box bg-gradient after:absolute after:inset-0 after:z-10 after:h-full after:w-full after:transition-opacity after:duration-500 hover:bg-white">
                        <div class="absolute inset-[3px] z-20 flex items-center justify-center bg-pink-900 text-white">24</div>
                      </div>

                      <div class="relative w-full h-12 cursor-pointer hover:scale-110 box bg-gradient after:absolute after:inset-0 after:z-10 after:h-full after:w-full after:transition-opacity after:duration-500 hover:bg-white">
                        <div class="absolute inset-[3px] z-20 flex items-center justify-center bg-pink-900 text-white">25</div>
                      </div>

                      <div class="relative w-full h-12 cursor-pointer hover:scale-110 box bg-gradient after:absolute after:inset-0 after:z-10 after:h-full after:w-full after:transition-opacity after:duration-500 hover:bg-white">
                        <div class="absolute inset-[3px] z-20 flex items-center justify-center bg-pink-900 text-white">26</div>
                      </div>

                      <div class="relative w-full h-12 cursor-pointer hover:scale-110 box bg-gradient after:absolute after:inset-0 after:z-10 after:h-full after:w-full after:transition-opacity after:duration-500 hover:bg-white">
                        <div class="absolute inset-[3px] z-20 flex items-center justify-center bg-pink-900 opacity-25 text-white">27</div>
                      </div>

                      <div class="relative w-full h-12 cursor-pointer hover:scale-110 box bg-gradient after:absolute after:inset-0 after:z-10 after:h-full after:w-full after:transition-opacity after:duration-500 hover:bg-white">
                        <div class="absolute inset-[3px] z-20 flex items-center justify-center bg-pink-900 text-white">28</div>
                      </div>

                      <div class="relative w-full h-12 cursor-pointer hover:scale-110 box bg-gradient after:absolute after:inset-0 after:z-10 after:h-full after:w-full after:transition-opacity after:duration-500 hover:bg-white">
                        <div class="absolute inset-[3px] z-20 flex items-center justify-center bg-pink-900 text-white">29</div>
                      </div>

                      <div class="relative w-full h-12 cursor-pointer hover:scale-110 box bg-gradient after:absolute after:inset-0 after:z-10 after:h-full after:w-full after:transition-opacity after:duration-500 hover:bg-white">
                        <div class="absolute inset-[3px] z-20 flex items-center justify-center bg-pink-900 opacity-25 text-white">30</div>
                      </div>

                      <div class="relative w-full h-12 cursor-pointer hover:scale-110 box bg-gradient after:absolute after:inset-0 after:z-10 after:h-full after:w-full after:transition-opacity after:duration-500 hover:bg-white">
                        <div class="absolute inset-[3px] z-20 flex items-center justify-center bg-pink-900 text-white">31</div>
                      </div>
                    </div>
                  </div>
                </GridItem>
