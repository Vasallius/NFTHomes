  ...
  return (
    <div className="bg-gray-900 text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <span className="text-3xl highlight font-extrabold bg-gradient-to-r from-f0516f to-c91e77 bg-clip-text">
          List Your Property
        </span>
        ...
        <div class="flex justify-between ">
          ...
          <div class="flex-grow">
            <form class="max-w-lg mx-auto mt-8">
              ...
              <div class="mb-4">
                <label for="price" class="block text-white font-bold mb-2  ">
                  Price per night
                </label>
                <div class="flex items-center">
                  <span class="rounded-l-md bg-gray-50 text-gray-900 px-3 py-2.5 text-sm font-medium">
                    USDT
                  </span>
                  <input
                    type="number"
              ...
              <div class="flex items-center">
                <button
                  type="submit"
                  class="bg-gradient-to-r from-pink-500 to-red-500 hover:from-pink-700 hover:to-red-700 text-white font-bold py-2 px-4 rounded"
                >
                  List Property
                </button>
              </div>
